...
public class PersistenceContext {
    ...
    public Map<String, Object> producerConfigs() {
        ...
        props.put(ProducerConfig.BOOTSTRAP_SERVERS_CONFIG, applicationConfiguration.getSpringKafkaBootstrapServers());
    ...
    public Map<String, Object> consumerConfigs() {
        Map<String, Object> props = new HashMap<>();
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, applicationConfiguration.getSpringKafkaBootstrapServers());
